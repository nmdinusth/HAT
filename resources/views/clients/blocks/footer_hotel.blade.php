                ...
                <div class="modal-body">
                    <div class="contact-form-action">
                        <form method="post" action="{{ route('login') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="custom-checkbox mb-0">
                                        <input type="checkbox" class="form-check-input" name="rememberchb"
                                            id="rememberchb" />
                            ...
                            <!-- end input-box -->
                            <div class="btn-box pt-3 pb-4">
                                <button type="button" id="btn-login" class="theme-btn w-100">
                                    Login Account
                                </button>
                            </div>
                            <div class="action-box text-center">
...
<script src=" {{ asset('ui/js/moment.min.js') }}"></script>
...
<script src=" {{ asset('ui/js/jquery.countTo.min.js') }}"></script>
<script src=" {{ asset('ui/js/animated-headline.js') }}"></script>
<script src=" {{ asset('ui/js/jquery.ripples-min.js') }}"></script>
<script src=" {{ asset('ui/js/quantity-input.js') }}"></script>
<script src=" {{ asset('ui/js/jquery.superslides.min.js') }}"></script>
...
<script>
    toastr.options = {
        ...
        "newestOnTop": true,
        "progressBar": true,
        "positionClass": "toast-top-right", // hoặc toast-bottom-center
        "preventDuplicates": true,
        "showDuration": "300",
        "hideDuration": "1000",
        "timeOut": "4000", // tự tắt sau 4s
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/html/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jun 2025 08:55:39 GMT -->
