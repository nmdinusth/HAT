    ...
    <section class="room-detail-bread">
      <div class="full-width-slider carousel-action">
        <div class="full-width-slide-item">
          <img src="{{ asset('ui/images/img30.jpg') }}" alt="" />
        </div>
        <!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
          <img src="{{ asset('ui/images/img31.jpg') }}" alt="" />
        </div>
        <!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
          <img src="{{ asset('ui/images/img32.jpg') }}" alt="" />
        </div>
        <!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
          <img src="{{ asset('ui/images/img33.jpg') }}" alt="" />
        </div>
        <!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
          <img src="{{ asset('ui/images/img34.jpg') }}" alt="" />
        </div>
        <!-- end full-width-slide-item -->
      </div>
              ...
              <div class="single-content-wrap padding-top-60px">
                <div id="description" class="page-scroll">
                  <div class="single-content-item pb-4">
                    <h3 class="title font-size-26">Premium Lake View Room</h3>
                    <p class="pt-2">
                      <span
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="section-heading text-center">
              <h2 class="sec__title">Other Rooms</h2>
              <p class="sec__desc">Could also be interest for you</p>
            </div>
            <!-- end section-heading -->
          </div>
          <!-- end col-lg-12 -->
