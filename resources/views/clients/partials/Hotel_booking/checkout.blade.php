                          ...
                          <div class="form-group mb-0">
                            <div class="custom-checkbox mb-0">
                              ...
                              <label for="receiveChb"
                                >I want to receive Trizen's promotional offers
                                in the future</label
                              >
                            </div>
                          </div>
                ...
                <div class="section-tab check-mark-tab text-center pb-4">
                  ...
                  >
                    ...
                    <li class="nav-item">
                      ...
                      >
                        <i class="la la-check icon-element"></i>
                        <img src="{{ asset('ui/images/paypal.png') }}" alt="" />
                    ...
                    <li class="nav-item">
                      ...
                      >
                        <i class="la la-check icon-element"></i>
                        <img src="{{ asset('ui/images/payoneer.png') }}" alt="" />
                ...
                <div class="card-item shadow-none radius-none mb-0">
                  <div class="card-img pb-4">
                    <a href="room-details.html" class="d-block">
                      <img src="{{ asset('ui/images/img5.jpg') }}" alt="room-img" />
                    </a>
                  </div>
                  <div class="card-body p-0">
                    <div class="d-flex justify-content-between">
                      ...
                      <div>
                        <a href="room-details.html" class="btn ms-1"
                          ><i
                            class="la la-edit"
                    ...
                    <ul class="list-items list-items-2 list-items-flush py-2">
                      <li class="font-size-15">
                        <span class="w-auto d-block mb-n1"
                          ><i class="la la-calendar me-1 font-size-17"></i
                          >From</span
                        >12 May 2020 7:40am
                      </li>
                      <li class="font-size-15">
                    ...
                    <ul class="list-items list-items-2 py-3">
                      ...
                      <li>
                        <span>Extra Services:</span>Cleaning, Laundry, Breakfast
                      </li>
                    </ul>
                    <div class="section-block"></div>
