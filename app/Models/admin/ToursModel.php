...
class ToursModel extends Model
{
    ...
    {
        // Xóa các dữ liệu liên quan trong bảng 'timeline' và 'images'
        $deleteTimeLine = DB::table('timeline')->where('tourId', $tourId)->delete();
        $deleteImages = DB::table('images')->where('tourId', $tourId)->delete();
